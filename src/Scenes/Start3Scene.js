export default class Start3 extends Phaser.Scene {
    constructor() {
        super({ key: "Start3" });
    }
    ...
    create() {
        ...
        this.chapter3 = this.sound.add('chapter3', { volume: window.GameVolume, loop: true });
        this.chapter3.play();
        ...
        // create player
        this.p = this.physics.add.sprite(170, 370, 'hero');
        ...
        this.map = this.make.tilemap({ key: "man3" });
        ...
        this.flyList = []
        let flyLocation = [
            { x: 900, y: 500, speed: 100, direction: 1, move: 'x', min: 900, max: 1350 },
            { x: 1750, y: 400, speed: 100, direction: 1, move: 'y', min: 400, max: 470 },
        ]
        ...
        this.destination_door = this.add.sprite(4170, 50, 'door');
        ...
        // Draw the field of view area (using black fill and translucency effects)
        ...
        var copyP = this.physics.add.sprite(170, 370, 'hero');
        ...
        // text
        this.dialogues = [
            { speaker: 'Boss', text: `Meaning? I'm surprised you came to this level.` },
            { speaker: 'Player', text: `I'm ready for it.` },
        ];
